...
//http://www.atomstroyexport.ru/wps/wcm/connect/ase/eng/journalists/press/

$atom = new \ParseIt\Donor\AtomstroyexportRu();

$atom_s = $atom->getSources(['url' => 'http://www.atomstroyexport.ru/wps/wcm/connect/ase/eng/journalists/press/']);
$fp = fopen('4.atomstroyexport_eng.csv','w');
...
//http://archive.niaep.ru/wps/wcm/connect/niaep/site.eng/press/companynews/
$niaep_s = $niaep->getSources(['url' => 'http://archive.niaep.ru/wps/wcm/connect/niaep/site.eng/press/companynews/']);
$fp = fopen('5.niaep_eng.csv','w');
fwrite($fp, "№,источник,заголовок,дата,текст,фотки,основная фотка\r\n");
